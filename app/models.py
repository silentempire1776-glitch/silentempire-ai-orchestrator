...
# ==========================================
# CHAIN RUN TRACKING (Option B - Elite)
# ==========================================
...
class ChainRun(Base):
    ...
    results_by_agent = Column(JSONB, nullable=True)  # {agent: {output, meta...}}
    ceo_summary = Column(Text, nullable=True)
...
class ChainStep(Base):
    ...
    agent = Column(String, nullable=False)  # research|revenue|...
    status = Column(String, default="queued")  # queued|running|completed|failed

    output = Column(Text, nullable=True)
    meta = Column(JSONB, nullable=True)  # tokens, model, provider, etc.
    error_message = Column(Text, nullable=True)
